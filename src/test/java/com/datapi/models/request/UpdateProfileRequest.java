package com.datapi.models.request;
...
public class UpdateProfileRequest {
    ...
    public static class Builder{
        ...
        private Builder mobileNumber(String mobileNumber){
            this.firstName = firstName;
            return this;
        }

        public UpdateProfileRequest build(){
            UpdateProfileRequest profileRequest = new UpdateProfileRequest(firstName,lastName,email,mobileNumber);
